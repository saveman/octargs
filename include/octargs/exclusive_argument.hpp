...
class basic_exclusive_argument : public basic_argument_base<basic_exclusive_argument,
                                     internal::basic_exclusive_argument_impl, char_T, values_storage_T, data_T>
{
public:
