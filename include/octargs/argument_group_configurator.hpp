#ifndef OCTARGS_ARGUMENT_GROUP_CONFIGURATOR_HPP_
#define OCTARGS_ARGUMENT_GROUP_CONFIGURATOR_HPP_

#include "internal/argument_group.hpp"
...
class basic_argument_group_configurator
{
public:
    ...
    basic_argument_group_configurator(argument_group_ptr_type argument_group)
    ...
    basic_argument_group_configurator& set_description(const string_type& description)
    {
...
#endif // OCTARGS_ARGUMENT_GROUP_CONFIGURATOR_HPP_
